...
'''
    ...
    def test_{index + 1}(self):
        dart_file = "{solution_file}"
        input_file = "{input_file}"
        output_file = "{output_file}"

        DartRunner.compile_dart(dart_file)
        output = DartRunner.run_dart(dart_file, input_file)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Process Dart solution file.")
    parser.add_argument("--solution", type=str, required=True, help="Path to the Dart solution file")
